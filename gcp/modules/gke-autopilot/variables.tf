...
variable "region" {
  type        = string
  description = "The region to host the cluster in (required for Autopilot)"
}
...
variable "release_channel" {
  type        = string
  description = "The release channel of this cluster. Accepted values are `UNSPECIFIED`, `RAPID`, `REGULAR` and `STABLE`. Defaults to `REGULAR` for Autopilot."
  default     = "REGULAR"
}
